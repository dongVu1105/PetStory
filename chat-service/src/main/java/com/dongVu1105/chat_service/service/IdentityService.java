...
import com.dongVu1105.chat_service.repository.httpclient.IdentityClient;
...
public class IdentityService {
    ...
    public IntrospectResponse introspect (IntrospectRequest request){
        IntrospectResponse introspectResponse = identityClient.introspect(request).getResult();
